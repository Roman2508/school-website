      ...
      <div ref={topRef}>
        {data.announcement_bar_text && (
          <div className="bg-stats-gradient">
            <div className="container flex flex-col gap-3 py-2 sm:flex-row sm:items-center sm:justify-between">
              <p className="min-w-0 flex-1 text-left text-sm font-medium text-white">
                {data.announcement_bar_text}
              </p>
